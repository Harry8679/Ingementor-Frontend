...
export default function SuperAdminAdmins() {
  ...
  const handleUpdateAdmin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await api.put(`/api/super-admin/admins/${selectedAdmin.id}`, payload);
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 mt-1">Créez et gérez les comptes administrateurs</p>
        </div>
        <button
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-md mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleCreateAdmin} className="p-6 space-y-4">
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  type="submit"
                  className="flex-1 px-4 py-2.5 bg-linear-to-r from-red-500 to-orange-500 text-white rounded-xl font-medium shadow-lg shadow-red-500/30 hover:shadow-xl transition-all"
                >
                  Créer
                </button>
              </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-md mx-4 max-h-[90vh] overflow-y-auto">
            <div className="p-6 border-b border-gray-100">
              <h2 className="text-xl font-bold text-gray-900 flex items-center gap-2">
                ...
                Modifier {selectedAdmin.fullName}
              </h2>
            </div>
            <form onSubmit={handleUpdateAdmin} className="p-6 space-y-4">
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  type="submit"
                  className="flex-1 px-4 py-2.5 bg-linear-to-r from-blue-500 to-indigo-500 text-white rounded-xl font-medium shadow-lg shadow-blue-500/30 hover:shadow-xl transition-all"
                >
                  Enregistrer
                </button>
              </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm mx-4">
            <div className="p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-lg font-bold text-gray-900">Supprimer l'administrateur</h2>
              </div>
              <p className="text-gray-600 mb-6">
                Êtes-vous sûr de vouloir supprimer{' '}
                <span className="font-bold">{selectedAdmin.fullName}</span> ? Cette action est
                irréversible.
              </p>

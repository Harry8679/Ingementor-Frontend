...
import { CogIcon, BellIcon, MoonIcon, GlobeAltIcon, ShieldCheckIcon, UserIcon, EnvelopeIcon, LockClosedIcon } from '@heroicons/react/24/solid';
        ...
        <main className="flex-1 p-8 relative z-10">
          <div className="max-w-4xl mx-auto space-y-8">
            <div>
              ...
              <p className="text-xl text-gray-600 mt-2 font-medium">Configuration du compte</p>
            </div>

            <Card>
              <div className="flex items-center gap-4 mb-6">
                <CogIcon className="h-7 w-7 text-pink-600" />
            ...
            <Card>
              <div className="flex items-center gap-4 mb-6">
                <BellIcon className="h-7 w-7 text-pink-600" />
              ...
              <div className="space-y-4">
                {[
                  ...
                  { key: 'grades', label: 'Nouvelles notes', desc: 'Notes de vos enfants' },
                  { key: 'lessons', label: 'Cours et rendez-vous', desc: 'Rappels de cours' },
                  { key: 'messages', label: 'Nouveaux messages', desc: 'Messages des professeurs' },
                  ...
                  <div key={notif.key} className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                    ...
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input 
                        type="checkbox" 
                        checked={(notifications as Record<string, boolean>)[notif.key]} 
                        onChange={() => setNotifications({...notifications, [notif.key]: !(notifications as Record<string, boolean>)[notif.key]})} 
            ...
            <Card>
              <div className="flex items-center gap-4 mb-6">
                <MoonIcon className="h-7 w-7 text-pink-600" />
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-900 font-medium">{language === 'fr' ? 'Français' : 'English'}</p>
                    </div>
                  </div>
                  <select value={language} onChange={(e) => setLanguage(e.target.value)} className="px-4 py-2 bg-white border-2 border-gray-200 rounded-xl font-medium focus:border-pink-500 focus:ring-4 focus:ring-pink-100">
            ...
            <Card>
              <div className="flex items-center gap-4 mb-6">
                <ShieldCheckIcon className="h-7 w-7 text-pink-600" />

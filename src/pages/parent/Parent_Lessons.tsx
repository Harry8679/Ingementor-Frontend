...
const Lessons: React.FC = () => {
  ...
  const loadLessons = async (): Promise<void> => {
    try {
      // TODO: API call
      setLessons([
        { id: 1, childName: 'Emma', subject: 'Mathématiques', teacher: 'M. Martin', date: '2026-02-05', time: '14:00', duration: 60, status: 'SCHEDULED' },
        { id: 2, childName: 'Lucas', subject: 'Physique', teacher: 'Mme Dubois', date: '2026-02-05', time: '16:00', duration: 90, status: 'SCHEDULED' },
        { id: 3, childName: 'Emma', subject: 'Français', teacher: 'M. Bernard', date: '2026-02-04', time: '10:00', duration: 60, status: 'COMPLETED', notes: 'Très bon cours' },
        { id: 4, childName: 'Lucas', subject: 'Histoire', teacher: 'Mme Leroy', date: '2026-02-03', time: '14:00', duration: 60, status: 'COMPLETED' }
      ]);
    } catch (error) {
      ...
      <div className="flex">
        ...
        <main className="flex-1 p-8 relative z-10">
          <div className="max-w-7xl mx-auto space-y-8">
            ...
            {/* Header */}
            <div>
              <h1 className="text-5xl font-black text-gray-900">Cours 📅</h1>
              <p className="text-xl text-gray-600 mt-2 font-medium">
                Planning des cours de vos enfants
              </p>
            </div>
              ...
              <Card>
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-3xl font-black text-gray-900">{upcomingLessons}</p>
                  </div>
                </div>
              </Card>
              ...
              <Card>
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-3xl font-black text-gray-900">{completedLessons}</p>
                  </div>
                </div>
              </Card>
              ...
              <Card>
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-3xl font-black text-gray-900">{lessons.length}</p>
                  </div>
                </div>
              </Card>
            </div>
